   ...
   if(isset($_POST["action"])) 
   {
    ...
    if($statement->rowCount() > 0)
    {
     foreach($result as $row)
     {
      ...
      <a style="display: none" class="btn btn-primary btn-block" href="#" onclick="DeplaceToi(this)"><i class="fa fa-arrow-left" aria-hidden="true"></i></a>
      <a class="btn btn-primary btn-block" href="#" onclick="DeplaceToi(this)"><i class="fa fa-arrow-right" aria-hidden="true"></i></a>
      </div>
      </div>';
