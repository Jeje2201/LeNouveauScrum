    ...
    if (isset($_POST["action"])) {
      ...
      if ($_POST["action"] == "RemplirTableau") {
        ...
        if ($row["tache_done"] == null)
          ...
          $output .='<td><center><div class="btn-group" role="group" ><button  id="' . $row["tache_pk"] . '" class="btn btn-warning update"><i class="fa fa-pencil" aria-hidden="true"></i></button><button  id="' . $row["tache_pk"] . '" class="btn btn-danger delete"><i class="fa fa-trash" aria-hidden="true"></i></button></div></center></td>';
          }
        } else {
          $output .= '
          <tr>
