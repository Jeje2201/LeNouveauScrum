...
<div class="row">
        ...
        <div class="col-xl-3 col-sm-6 mb-3">
          <div class="card text-white bg-danger h-100">
            ...
            <a class="card-footer text-white small">
              <span class="float-left"> <button onclick="GoTop(this)">Monter</button> </span>
              <span class="float-right"> <button onclick="GoDown(this)">Descendre</button> </span>
            </a>
          </div>
        </div>
      </div>
